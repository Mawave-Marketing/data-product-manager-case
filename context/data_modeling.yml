...
| Layer | Purpose | Key Activities | Input | Output |
|-------|---------|----------------|-------|--------|
| **Data** | Raw data storage | Storage, historization | Source systems | Normalized raw data |
| **Clean** | Data quality & consistency | Cleaning, validation, optimization | Raw data | Clean, consistent data |
| **Integration** | Data refinement | Complex transformations, filtering | Clean data | Refined data objects |
| **Object** | Business entity modeling | Abstraction, core business definitions | Clean/Integration data | Business entities |
| **Business** | KPI & analytics | KPI definitions, aggregations | Object data | Business metrics |
| **Reporting** | Optimized reporting | Performance optimization, specific joins | Business/Object data | Report-ready data |
